...
This purpose of this assignment is to create three visualizations to answer a question about Moorea coral reefs (MCR) for a general non-scientific audience, a publication, and a presentation.

**Note: ggradar was not compatible with updated R versions so all of the ggradar code is commented out now, resulting graph is still shown.
